...
from integrations.hubspot import authorize_hubspot, get_hubspot_credentials, get_items_hubspot as fetch_items_hubspot, oauth2callback_hubspot
...
async def get_items_hubspot(credentials: str = Form(...)):
    return await fetch_items_hubspot(credentials)
